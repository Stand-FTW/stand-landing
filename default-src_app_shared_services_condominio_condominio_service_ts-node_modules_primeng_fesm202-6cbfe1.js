"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["default-src_app_shared_services_condominio_condominio_service_ts-node_modules_primeng_fesm202-6cbfe1"],{

/***/ 32724:
/*!******************************************************************!*\
  !*** ./src/app/shared/services/condominio/condominio.service.ts ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CondominioService": () => (/* binding */ CondominioService)
/* harmony export */ });
...
let CondominioService = class CondominioService {
    constructor(http) {
        this.http = http;
    }
    list(filterDto, pageOptions = new _interfaces_others_pageable_dto__WEBPACK_IMPORTED_MODULE_1__.PageOptionsDto()) {
        ...
        if (filterDto && filterDto.searchedCondominio) {
        ...
        return this.http.get(`${_config_api_config__WEBPACK_IMPORTED_MODULE_0__.API_CONFIG.baseURL}/condominios`, {
            responseType: 'json',
            params,
        });
    }
    create(newCondominio) {
        return this.http.post(`${_config_api_config__WEBPACK_IMPORTED_MODULE_0__.API_CONFIG.baseURL}/condominios`, newCondominio, {
            responseType: 'json',
        });
    }
    update(updatedCondominio, Condominio_id) {
        return this.http.put(`${_config_api_config__WEBPACK_IMPORTED_MODULE_0__.API_CONFIG.baseURL}/condominios/${Condominio_id}`, updatedCondominio, {
            responseType: 'json',
        });
    }
    createOrUpdateEndereco(Condominio_id, newEndereco) {
        return this.http.post(`${_config_api_config__WEBPACK_IMPORTED_MODULE_0__.API_CONFIG.baseURL}/condominios/${Condominio_id}/endereco`, newEndereco, {
            responseType: 'json',
        });
    }
};
CondominioService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__.HttpClient }
];
CondominioService = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
...
//# sourceMappingURL=default-src_app_shared_services_condominio_condominio_service_ts-node_modules_primeng_fesm202-6cbfe1.js.map